...
function splitEnumMembers(body: string) {
    const result = [];
...
function evaluateExpression(expr: string, symbols: Record<string, number>) {
    expr = expr.trim();
...
function parseDefines(src: string, symbols: Record<string, number>) {
    const defineRegex =
...
function parseEnum(kind: string, enumName: string, body: string, symbols: Record<string, number>, options: Record<string, boolean>) {
...
export function parseEnums(src: string, options: Record<string, boolean>) {
